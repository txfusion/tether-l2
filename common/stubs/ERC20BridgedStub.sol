...
contract ERC20BridgedStub is IERC20Bridged, ERC20 {
    ...
    function bridgeMint(address account, uint256 amount) external onlyNotFrozen(account) {
        _mint(account, amount);
    }

    function bridgeBurn(address account, uint256 amount) external onlyNotFrozen(account) {
