...
import {IL1SharedBridge} from "@matterlabs/zksync-contracts/l1-contracts/contracts/bridge/interfaces/IL1SharedBridge.sol";
import {IL2Bridge} from "@matterlabs/zksync-contracts/l1-contracts/contracts/bridge/interfaces/IL2Bridge.sol";

import {IMailbox} from "@matterlabs/zksync-contracts/l1-contracts/contracts/state-transition/chain-interfaces/IMailbox.sol";
...
import {IBridgehub, L2TransactionRequestTwoBridgesInner, L2TransactionRequestDirect} from "@matterlabs/zksync-contracts/l1-contracts/contracts/bridgehub/IBridgehub.sol";
import {IGetters} from "@matterlabs/zksync-contracts/l1-contracts/contracts/state-transition/chain-interfaces/IGetters.sol";
import {L2_BASE_TOKEN_SYSTEM_CONTRACT_ADDR} from "@matterlabs/zksync-contracts/l1-contracts/contracts/common/L2ContractAddresses.sol";
...
contract L1SharedBridge is Initializable, IL1SharedBridge, ReentrancyGuard, Ownable2StepUpgradeable, PausableUpgradeable, BridgeableTokensUpgradable, BridgingManagerUpgradeable
{
    ...
    function initialize(address _owner, address _l1Token) external reentrancyGuardInitializer initializer onlyNonZeroAddress(_l1Token) onlyNonZeroAddress(_owner) {
    ...
    function transferFundsFromLegacy(address _token, address _target, uint256 _targetChainId) external onlyOwner onlySupportedL1Token(_token) {
    ...
    ) external payable override onlyLegacyBridge nonReentrant whenNotPaused onlySupportedL1Token(_l1Token) whenDepositsEnabled returns (bytes32 l2TxHash) {
    ...
    function finalizeWithdrawalLegacyErc20Bridge(
        ...
        bytes calldata _message,
        bytes32[] calldata _merkleProof
    ) external override onlyLegacyBridge whenWithdrawalsEnabled returns (address l1Receiver, address l1Token, uint256 amount) {
